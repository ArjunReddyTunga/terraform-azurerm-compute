...
vm_name                   = "DEMOWIN"        # VM Name
app                       = "XYZ"           # Worload Name
...
vm_sku_type = "Standard_B4ms" # VM SKU Model which is available in WEU region
...
diag_storage_name = "https://bootdaigsa01.blob.core.windows.net/" # For Boot Diagnostics
...
delete_os_disk          = "false"                    # Delete Disk [ ture / false ]
delete_data_disks       = "false"                    # Delete Disk [ ture / false ]
